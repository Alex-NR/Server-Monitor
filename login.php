...
<!--<![endif]-->
    ...
    <head>
        ...
        <title>Native Rank Server Monitor | Login</title>
            ...
            <div class="main wrapper clearfix">
                <article>
                    <section>
						...
						<form id="loginForm" action="/web/login.php" method="post">
							<input id="username" type="text" name="username" placeholder="Username or E-mail"><br>
